...
public class VisualizerActivity extends AppCompatActivity
    ...
    private void defaultSetup() {
        ...
        // bước tiến vượt bậc khi lấy từ pref_visualizer.xml preferencescreen
        // lấy đc mọi lúc mọi nơi
...
//        mVisualizerView.setMinSizeScale(1);
    ...
    private void loadColorFromPreferences(SharedPreferences preferences){
        mVisualizerView.setColor(preferences
                .getString(getString(R.string.pref_color_key),"red"));
    }

    private void loadSizeFromPreference(SharedPreferences preferences){
        float minSize = Float.parseFloat(preferences.getString(getString(R.string.pref_size_key)
    ...
    public void onSharedPreferenceChanged(SharedPreferences sharedPreferences, String key) {
        ...
        switch (key){
            ...
            case "show_mid":
                ...
                .getBoolean(key, getResources().getBoolean(R.bool.pref_show_mid_default)));
